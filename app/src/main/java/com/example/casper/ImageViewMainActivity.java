...
public class ImageViewMainActivity extends AppCompatActivity {
    ...
    private Button buttonPrevious = findViewById(R.id.button_previous), buttonNext = findViewById(R.id.buttonHelloEn);
    private ImageView imageViewFunny = findViewById(R.id.image_view_funny);
    ...
    public ImageViewMainActivity(int iTest) {
